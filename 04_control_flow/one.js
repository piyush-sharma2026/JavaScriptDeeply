...
if (true) {
    console.log("This is true"); // it will work
}

if (false) {
    console.log("This is false"); // code will not work 
}
...
if (0) {
    console.log("This is falsy"); // This will not be printed because 0 is a falsy value
}
else {
    console.log("This is truthy"); // This will be printed because 0 is a falsy value
}
